...
public class HotelListAdapter extends RecyclerView.Adapter<HotelListAdapter.MyViewHolder> {
    ...
    public HotelListAdapter(Context c, ArrayList<Hotel> h) {
        context = c;
        hotels = h;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder((LayoutInflater.from(context).inflate(R.layout.hotels_list_row, parent, false)));
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView hotelName, cityName, roomType, price;
